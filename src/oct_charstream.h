...
typedef struct oct_CharstreamFunctions {
	oct_Bool (*readChar)(struct oct_Context* ctx, oct_BGeneric self, oct_Char* out_read);
	oct_Bool (*peekChar)(struct oct_Context* ctx, oct_BGeneric self, oct_Char* out_peeked);
